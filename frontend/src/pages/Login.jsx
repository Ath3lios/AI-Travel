  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .auth-input:focus { border-color: #0ea5e9; background: white; box-shadow: 0 0 0 3px rgba(14,165,233,0.08); }
        ...
        .auth-btn:hover:not(:disabled) { box-shadow: 0 6px 20px rgba(14,165,233,0.45); transform: translateY(-1px); }
